...
public class SaleServiceFindBySuccess implements ArgumentsProvider {

	@Override
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		return Stream.of(
				Arguments.of(1,"Thidar",
						List.of(new SaleItem("P0001", "Egg L Size", 500, 3))
						),
	...
	public static record SaleItem(String code, String name,int unitPrice, int quantity) {}
}
